package com.roro.clustereureka9001;
...
@EnableEurekaServer
public class ClusterEureka9001Application {

    public static void main(String[] args) {
        SpringApplication.run(ClusterEureka9001Application.class, args);
        ...
        System.err.println("二、@EnableEurekaServer和com.roro.clustereureka9001.config.SecurityConfig");
