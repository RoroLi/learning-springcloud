package com.roro.msconsumertimeoutdemo;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

@SpringBootApplication
public class ConsumerTimeoutDemoApplication {

    public static void main(String[] args) {
        SpringApplication.run(ConsumerTimeoutDemoApplication.class, args);
        ...
        System.out.println("本模块启动后，访问http://localhost:4200/hello");
